                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-block auth-logo">
                                            <img src={enLogoWhite} alt="" height="20" />
                                        </Link>
                                    </div>
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">Last Name <span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="confirm_password"
                                                        type="password"
                                                        placeholder="Confirm Password"
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">First Name <span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="confirm_password"
                                                        type="password"
                                                        placeholder="Confirm Password"
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">Phone # <span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="confirm_password"
                                                        type="password"
                                                        placeholder="Confirm Password"
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">Zip Code <span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="confirm_password"
                                                        type="password"
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">Address <span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="Address"
                                                        type="text"
                                                        placeholder="Address"
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">Village <span className="text-danger">*</span></Label>
                                                    <Input
                                                        name="Village"
                                                        type="text"
                                                        placeholder="Village"
